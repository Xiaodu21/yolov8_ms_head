_base_ = [
    '../_base_/datasets/dota.py', '../_base_/schedules/schedule_0x.py',
...
model = dict(
    ...
    rpn_head=dict(
        ...
        bbox_coder=dict(
            ...
            type='DeltaXYWHHBBoxCoder',  # 好像不是这个原因
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=[
            ...
            dict(
                type='RotatedSingleRoIExtractor',# 不确定
                roi_layer=dict(
        ...
        bbox_head=[
            dict(
                ...
                bbox_coder=dict(
                    type='DeltaXYWHTHBBoxCoder',# 找到了不过也没发现问题
